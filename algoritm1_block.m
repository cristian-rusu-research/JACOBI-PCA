function [positions, values, approx_error, tus, Ubar, S, diagonal] = algoritm1_block(S, b, p)
%% Algorithm 1, block version
%% Input:
% S - a symmetric matrix of size dxd
% b - the number of generalized block transformations to use for the
% approximation of the eigenspace (size of block is 2p)
